...
public final class EnvelopeHelpers {
    ...
    static InitialHere createInitialHere(String anchorString, int yOffsetPixels, int xOffsetPixels) {
    ...
    static Text createText(String anchorString, int yOffsetPixels, int xOffsetPixels) {
    ...
    static DateSigned createDateSigned(String anchorString, int yOffsetPixels, int xOffsetPixels) {
    ...
    static FullName createFullName(String anchorString, int yOffsetPixels, int xOffsetPixels){
