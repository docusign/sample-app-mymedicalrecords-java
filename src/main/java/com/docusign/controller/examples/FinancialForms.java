...
public class FinancialForms extends AbstractEsignatureController{
    ...
    private static EnvelopeDefinition makeEnvelope(String signerEmail, String signerName) throws IOException {
        ...
        //       EnvelopeHelpers.createSignHere("*sn2*", ANCHOR_OFFSET_Y, ANCHOR_OFFSET_X));

        //Tabs textTabs = EnvelopeHelpers.createTextTabs(
        //    EnvelopeHelpers.createText("*txt2", ANCHOR_OFFSET_Y, ANCHOR_OFFSET_X));

        //Tabs dateTabs = EnvelopeHelpers.createDateSignedTabs(
        //    EnvelopeHelpers.createDateSigned("*ds2*", ANCHOR_OFFSET_Y, ANCHOR_OFFSET_X));

        //Tabs fullNameTabs = EnvelopeHelpers.createFullNameTabs(
        //    EnvelopeHelpers.createFullName("*nm2*", ANCHOR_OFFSET_Y, ANCHOR_OFFSET_X));
