...
public class ConsentForms extends AbstractEsignatureController{
    ...
    public static EnvelopeDefinition createEnvelope(WorkArguments args) throws IOException {
        ...
        //Tabs initalTabs = EnvelopeHelpers.createInitialTabs(
        //            EnvelopeHelpers.createInitialHere("*in1*", ANCHOR_OFFSET_Y, ANCHOR_OFFSET_X));

        //Tabs dateSignedTabs = EnvelopeHelpers.createDateSignedTabs(
        //    EnvelopeHelpers.createDateSigned("*ds1*", ANCHOR_OFFSET_Y, ANCHOR_OFFSET_X));
