...
import com.docusign.controller.common.ExampleException;
...
public final class EnvelopeHelpers {
     ...
     */
    public static byte[] createHtmlFromTemplate(Template template, String objectName, Object value) throws IOException {
    ...
    public static InitialHere createInitialHere(String anchorString, int yOffsetPixels, int xOffsetPixels) {
        InitialHere initialHere = new InitialHere();
        initialHere.setAnchorString(anchorString);
        initialHere.setAnchorUnits("pixels");
        initialHere.setAnchorYOffset(String.valueOf(yOffsetPixels));
        initialHere.setAnchorXOffset(String.valueOf(xOffsetPixels));
        return initialHere;
    }

    public static Text createText(String anchorString, int yOffsetPixels, int xOffsetPixels) {
        Text textHere = new Text();
        textHere.setAnchorString(anchorString);
        textHere.setAnchorUnits("pixels");
        textHere.setAnchorYOffset(String.valueOf(yOffsetPixels));
        textHere.setAnchorXOffset(String.valueOf(xOffsetPixels));
        return textHere;
    }

    public static DateSigned createDateSigned(String anchorString, int yOffsetPixels, int xOffsetPixels) {
        DateSigned dateSigned = new DateSigned();
        dateSigned.setAnchorString(anchorString);
        dateSigned.setAnchorUnits("pixels");
        dateSigned.setAnchorYOffset(String.valueOf(yOffsetPixels));
        dateSigned.setAnchorXOffset(String.valueOf(xOffsetPixels));
        return dateSigned;
    }

    public static FullName createFullName(String anchorString, int yOffsetPixels, int xOffsetPixels){
        FullName fullName = new FullName();
        fullName.setAnchorString(anchorString);
        fullName.setAnchorUnits("pixels");
        fullName.setAnchorYOffset(String.valueOf(yOffsetPixels));
        fullName.setAnchorXOffset(String.valueOf(xOffsetPixels));
        return fullName;
    }
    /**
    ...
    public static Tabs createInitialTabs(InitialHere... initials) {
        Tabs initalTabs = new Tabs();
        initalTabs.setInitialHereTabs(Arrays.asList(initials));
        return initalTabs;
    }

    public static Tabs createTextTabs(Text... texts){
        Tabs textTabs = new Tabs();
        textTabs.setTextTabs(Arrays.asList(texts));
        return textTabs;
    }

    public static Tabs createDateSignedTabs(DateSigned... dates){
        Tabs dateTabs = new Tabs();
        dateTabs.setDateSignedTabs(Arrays.asList(dates));
        return dateTabs;
    }

    public static Tabs createFullNameTabs(FullName... names){
        Tabs nameTabs = new Tabs();
        nameTabs.setFullNameTabs(Arrays.asList(names));
        return nameTabs;
    }
    /**
