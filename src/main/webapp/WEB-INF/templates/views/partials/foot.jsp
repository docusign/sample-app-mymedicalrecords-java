<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <div class="footer" style="position: absolute; width: 100%; height: 312px;margin-top: 2rem; bottom:-60vh; left: -1px; background: #001730;">
          ...
          font-style: normal; font-weight: bold; font-size: 24px; line-height: 29px; color: #F9F9F9; z-index: 2;">
            ...
            font-weight: normal; font-size: 18px; line-height: 21px; text-align: center; color: #F9F9F9; z-index: 2;">
                                Docusign helps organizations connect and automate how they prepare, sign, act on and
                                manage agreements
                        </p>
